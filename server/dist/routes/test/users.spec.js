      ...
      describe.skip("禁止文字(\, / , :, *, ?, <, >, |)が含まれている場合", function () {
        describe("バックスラッシュ", function () {
          ...
          var user = (_user = {
            ...
            password: "t\\e\\s\\t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user, "password", "test"), (0, _defineProperty2["default"])(_user, "role_id", null), _user);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("スラッシュ", function () {
          ...
          var user = (_user2 = {
            ...
            password: "t/e/s/t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user2, "password", "test"), (0, _defineProperty2["default"])(_user2, "role_id", null), _user2);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("コロン", function () {
          ...
          var user = (_user3 = {
            ...
            password: "t:e:s:t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user3, "password", "test"), (0, _defineProperty2["default"])(_user3, "role_id", null), _user3);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("アスタリスク", function () {
          ...
          var user = (_user4 = {
            ...
            password: "t*e*s*t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user4, "password", "test"), (0, _defineProperty2["default"])(_user4, "role_id", null), _user4);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("クエスション", function () {
          ...
          var user = (_user5 = {
            ...
            password: "t?e?s?t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user5, "password", "test"), (0, _defineProperty2["default"])(_user5, "role_id", null), _user5);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("山括弧開く", function () {
          ...
          var user = (_user6 = {
            ...
            password: "t<e<s<t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user6, "password", "test"), (0, _defineProperty2["default"])(_user6, "role_id", null), _user6);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("山括弧閉じる", function () {
          ...
          var user = (_user7 = {
            ...
            password: "t>e>s>t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user7, "password", "test"), (0, _defineProperty2["default"])(_user7, "role_id", null), _user7);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
        ...
        describe("パイプ", function () {
          ...
          var user = (_user8 = {
            ...
            password: "t|e|s|t",
            email: "example@localhost"
          }, (0, _defineProperty2["default"])(_user8, "password", "test"), (0, _defineProperty2["default"])(_user8, "role_id", null), _user8);
          before(function (done) {
            request.get("/api/v1/role_menus").end(function (err, res) {
              user.role_id = (0, _lodash.head)(res.body.body)._id;
              request.post(users_url).send({
