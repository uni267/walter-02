  ...
  describe('get /:file_id', function () {
    ...
    describe('異常系', function () {
      ...
      describe('指定しているfile_idがフォルダ', function () {
        ...
        before(function (done) {
          ...
          new Promise(function (resolve, reject) {
            ...
            request.get("".concat(base_url, "/").concat(res[0]._id)).end(function (err, res) {
              response = res;
              done();
            });
          });
      ...
      describe('削除済みのfile_idを指定', function () {
        ...
        before(function (done) {
          new Promise(function (resolve, reject) {
            ...
            // ファイルをゴミ箱に移動
            return new Promise(function (resolve, reject) {
              request["delete"]("/api/v1/files/".concat(res.body.body[0]._id)).end(function (err, res) {
                resolve(res);
              });
            });
          }).then(function (res) {
            delete_file = res.body.body; // ファイルをゴミ箱から削除

            return new Promise(function (resolve, reject) {
              request["delete"]("".concat(base_url, "/").concat(delete_file._id, "/delete")).end(function (err, res) {
                resolve(res);
              });
            });
          }).then(function (res) {
            // ゴミ箱から削除したファイルの詳細を取得
            return new Promise(function (resolve, reject) {
              request.get("".concat(base_url, "/").concat(delete_file._id)).end(function (err, res) {
                response = res;
                resolve(res);
              });
            });
      ...
      describe('閲覧権限がないfile_id', function () {
        ...
        var response;
        before(function (done) {
          var url = "".concat(base_url, "/").concat(file_id);
          var new_auth_data = {
            account_name: "hanako",
            name: "hanako",
            email: "hanako",
    ...
    describe('正常系', function () {
      ...
      it('mime_typeはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.mime_type)).equal('string');
        done();
      });
      ...
      it('sizeはnumberである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.size)).equal('number');
        done();
      });
      ...
      it('is_dirはbooleanである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.is_dir)).equal('boolean');
        done();
      });
      ...
      it('dir_idはObjectIdである', function (done) {
        (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body.dir_id)).equal(true);
        done();
      });
      ...
      it('is_displayはbooleanである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.is_display)).equal('boolean');
        done();
      });
      ...
      it('is_starはbooleanである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.is_star)).equal('boolean');
        done();
      });
      ...
      it('is_cryptedはbooleanである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.is_crypted)).equal('boolean');
        done();
      });
      ...
      it('histories.actionはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body.histories).action)).equal('string');
        done();
      });
      ...
      it('historiesのuserはobjectである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body.histories).user)).equal('object');
        done();
      });
      ...
      it('histories.modifiedはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body.histories).modified)).equal('string');
        done();
      });
      ...
      it('is_deletedはbooleanである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.is_deleted)).equal('boolean');
        done();
      });
      ...
      it('modifiedはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.modified)).equal('string');
        done();
      });
      ...
      it('preview_idはnullまたはObjectIdである', function (done) {
        if (response.body.body.preview_id === null) {
          ...
          (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body.preview_id)).equal(true);
        }
