...
describe(base_url, function () {
  ...
  describe('get /', function () {
    describe('正常系', function () {
      ...
      it('actionsはobjectである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].actions)).equal('object');
        done();
      });
      ...
      it('labelはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].actions[0].label)).equal('string');
        done();
      });
      ...
      it('nameはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].actions[0].name)).equal('string');
        done();
      });
  ...
  describe('get /:role_id', function () {
    describe('異常系', function () {
      describe('存在しないrole_idを指定', function () {
        ...
        var response;
        before(function (done) {
          var role_id = new _mongoose["default"].Types.ObjectId();
          var url = "".concat(base_url, "/").concat(role_id);
          request.get(url).end(function (err, res) {
            response = res;
            done();
          });
  ...
  describe('patch /:role_id/actions/:action_id', function () {
    ...
    before(function (done) {
      // 実行前のデータを取得
      request.get(base_url).end(function (err, res) {
        otherDataBeforePatch = res.body.body; // actionsを取得

        request.get(actions_url).end(function (err, res) {
          actions = res.body.body; // テスト用データ登録
    ...
    describe('異常系', function () {
      describe('存在しないrole_idを更新する', function () {
        ...
        before(function (done) {
          ...
          var id = new _mongoose["default"].Types.ObjectId();
          request.patch("".concat(base_url, "/").concat(id, "/actions/").concat(action._id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('存在しないactionを登録する', function () {
        ...
        before(function (done) {
          var action = (0, _lodash.first)(actions);
          var id = new _mongoose["default"].Types.ObjectId();
          request.patch("".concat(base_url, "/").concat(targetData._id, "/actions/").concat(id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('既に登録されているactionを登録する', function () {
        ...
        before(function (done) {
          var action = (0, _lodash.first)(actions);
          var url = "".concat(base_url, "/").concat(targetData._id, "/actions/").concat(action._id);
    ...
    describe('正常系', function () {
      ...
      before(function (done) {
        ...
        request.patch("".concat(base_url, "/").concat(targetData._id, "/actions/").concat(targetAction._id)).end(function (err, res) {
          response = res;
          done();
        });
      });
  ...
  describe('delete /:role_id/actions/:action_id', function () {
    ...
    before(function (done) {
      ...
      request.get(base_url).end(function (err, res) {
        ...
        request.get(actions_url).end(function (err, res) {
          ...
          request.post(base_url).send(sendData).end(function (err, res) {
            targetData = res.body.body; // actionsを登録

            targetAction = (0, _lodash.first)(actions);
            action_id = (0, _lodash.first)(actions)._id;
            request.patch("".concat(base_url, "/").concat(targetData._id, "/actions/").concat(action_id)).end(function (err, res) {
              done();
            });
          });
        });
    ...
    describe('異常系', function () {
      describe('存在しないrole_idを更新する', function () {
        ...
        before(function (done) {
          var id = new _mongoose["default"].Types.ObjectId();
          request["delete"]("".concat(base_url, "/").concat(id, "/actions/").concat(action_id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('role_idにでたらめな文字列を指定して更新する', function () {
        ...
        before(function (done) {
          var action = (0, _lodash.first)(actions);
          var id = "asfjapfjioeawfjoejwafojfoeawjfiaoefw";
          request["delete"]("".concat(base_url, "/").concat(id, "/actions/").concat(action._id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('存在しないactionを登録する', function () {
        ...
        before(function (done) {
          var action = (0, _lodash.first)(actions);
          var id = new _mongoose["default"].Types.ObjectId();
          request["delete"]("".concat(base_url, "/").concat(targetData._id, "/actions/").concat(id)).end(function (err, res) {
            response = res;
            done();
          });
        });
    ...
    describe('正常系', function () {
      ...
      before(function (done) {
        request.get("".concat(base_url, "/").concat(targetData._id)).end(function (err, res) {
          dataBeforePatch = res.body.body;
          request["delete"]("".concat(base_url, "/").concat(targetData._id, "/actions/").concat(action_id)).end(function (err, res) {
            response = res;
            done();
          });
        });
