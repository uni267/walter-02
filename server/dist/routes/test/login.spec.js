...
describe(base_url, function () {
  ...
  describe("post /", function () {
    describe("request bodyがundefineの場合", function () {
      ...
      it("http(400)が返却される", function (done) {
        (0, _supertest["default"])(_builder.app).post(base_url).end(function (err, res) {
    ...
    describe("account_nameがnullの場合", function () {
      ...
      it("http(400)が返却される", function (done) {
        (0, _supertest["default"])(_builder.app).post(base_url).send(body).end(function (err, res) {
          (0, _chai.expect)(res.status).equal(400);
          done();
        });
      });
    ...
    describe("適切なaccount_name, passwordを渡した場合", function () {
      ...
      it("\u6982\u8981\u306F\u300C".concat(expected.message, "\u300D"), function (done) {
        (0, _supertest["default"])(_builder.app).post(base_url).send(body).end(function (err, res) {
          (0, _chai.expect)(res.body.status.message).equal(expected.message);
          done();
        });
  ...
  describe("post /verify_token", function () {
    ...
    describe("tokenが未定義の場合", function () {
      ...
      it("http(400)が返却される", function (done) {
        (0, _supertest["default"])(_builder.app).post(verify_token_url).send(body).end(function (err, res) {
          (0, _chai.expect)(res.status).equal(400);
          done();
        });
      });
    ...
    describe("検証可能なトークンを渡した場合", function (done) {
      ...
      before(function (done) {
        (0, _supertest["default"])(_builder.app).post(base_url).send({
          account_name: "hanako",
          password: "test"
      ...
      it.skip("\u6982\u8981\u306F\u300C".concat(expected.message, "\u300D"), function (done) {
        (0, _supertest["default"])(_builder.app).post(verify_token_url).send(body).end(function (err, res) {
          (0, _chai.expect)(res.body.status.message).equal(expected.message);
          done();
        });
