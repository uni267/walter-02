...
var user; // テスト用のアップロードファイル(client側から送信しているPayload)
  ...
  describe('get /search', function () {
      ...
      new Promise(function (resolve, reject) {
        ...
        return new Promise(function (resolve, reject) {
          request.get('/api/v1/meta_infos').end(function (err, res) {
            var _meta = (0, _lodash.find)(res.body.body, {
        ...
        return new Promise(function (resolve, reject) {
          for (var i = 0; i < keyWords.length; i++) {
            ...
            files.meta_infos = [{
              _id: meta._id,
              value: "meta_value_".concat(keyWords[i])
            }];
    ...
    describe('異常系', function () {
      ...
      describe('ソート条件が不正', function () {
        ...
        describe('sortが""', function () {
          var response;
          before(function (done) {
            request.get("".concat(base_url)).query({
              q: "test",
              sort: ''
            }).end(function (err, res) {
              response = res;
    ...
    describe('正常系', function () {
      ...
      describe('条件に半角英字を指定', function () {
        var url = "".concat(base_url, "/search");
        var response;
        before(function (done) {
          console.log("wait....");
          new Promise(function (resolve, reject) {
        ...
        before(function (done) {
          new Promise(function (resolve, reject) {
            ...
            request.get('/api/v1/role_files').end(function (err, res) {
              target_role = (0, _lodash.find)(res.body.body, {
                name: "フルコントロール"
              });
              resolve(target_role);
            });
            ...
            return new Promise(function (resolve, reject) {
              request.get('/api/v1/users').end(function (err, res) {
                target_user = (0, _lodash.find)(res.body.body, {
                  name: "hanako"
                });
                resolve(target_user);
              });
            ...
            return new Promise(function (resolve, reject) {
              // ファイル権限を追加
              request.post("/api/v1/files/".concat(target_file._id, "/authorities")).send({
                user: target_user,
                role: target_role
              }).end(function (err, res) {
        ...
        describe('並び替え', function () {
          ...
          describe('メタ情報', function () {
            describe('メタ情報「表示ファイル名」の降順', function () {
              var response;
              var file_metainfo_values;
              before(function (done) {
                new Promise(function (resolve, reject) {
                  var display_item = (0, _lodash.find)(display_items, {
                  ...
                  request.get("".concat(base_url, "/search")).query({
                    q: "txt",
                    sort: display_item.meta_info_id,
                    order: 'desc'
                  }).end(function (err, res) {
                    response = res;
