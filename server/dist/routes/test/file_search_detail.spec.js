...
var tags; // テスト用のアップロードファイル(client側から送信しているPayload)
      ...
      new Promise(function (resolve, reject) {
        ...
        return new Promise(function (resolve, reject) {
          request.get('/api/v1/meta_infos').end(function (err, res) {
            ...
            meta = {
              _id: (0, _lodash.find)(res.body.body, {
            ...
            for (var i = 0; i < keyWords.length; i++) {
              var meta_date = (0, _moment["default"])().add(i, "days").format("YYYY-MM-DD h:mm:ss");
        ...
        return new Promise(function (resolve, reject) {
          ...
          for (var i = 0; i < keyWords.length; i++) {
            ...
            files.name = "text_".concat(keyWords[i], ".txt");
            files.tags = [tags._id];
            files.meta_infos = [{
              _id: meta._id,
              value: "meta_value".concat(keyWords[i])
            }, meta_recieve_date[i]];
            _file = [].concat((0, _toConsumableArray2["default"])(_file), [files]);
          }
      ...
      describe('pageが不正', function () {
        ...
        describe('pageが""', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send = {}, (0, _defineProperty2["default"])(_request$post$send, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send, "page", ""), _request$post$send)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('pageが不正文字列', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send2 = {}, (0, _defineProperty2["default"])(_request$post$send2, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send2, "page", '\/:*?<>|'), _request$post$send2)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('pageが数字以外の文字列', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send3 = {}, (0, _defineProperty2["default"])(_request$post$send3, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send3, "page", 'ichi'), _request$post$send3)).end(function (err, res) {
              response = res;
              done();
            });
          });
      ...
      describe('ソート条件が不正', function () {
        ...
        describe('sortが""', function () {
          ...
          before(function (done) {
            ...
            request.get("".concat(base_url)).query((_request$get$query = {}, (0, _defineProperty2["default"])(_request$get$query, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$get$query, "sort", ''), _request$get$query)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('sortが不正な文字列', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send4 = {}, (0, _defineProperty2["default"])(_request$post$send4, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send4, "page", 0), (0, _defineProperty2["default"])(_request$post$send4, "sort", '\/:*?<>|'), _request$post$send4)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('sortが意図しない文字列', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send5 = {}, (0, _defineProperty2["default"])(_request$post$send5, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send5, "page", 0), (0, _defineProperty2["default"])(_request$post$send5, "sort", 'ichi'), _request$post$send5)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('orderが""', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send6 = {}, (0, _defineProperty2["default"])(_request$post$send6, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send6, "page", 0), (0, _defineProperty2["default"])(_request$post$send6, "order", ''), _request$post$send6)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('orderが不正文字列', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send7 = {}, (0, _defineProperty2["default"])(_request$post$send7, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send7, "page", 0), (0, _defineProperty2["default"])(_request$post$send7, "order", '\/:*?<>|'), _request$post$send7)).end(function (err, res) {
              response = res;
              done();
            });
          });
        ...
        describe('orderが意図しない文字列', function () {
          ...
          before(function (done) {
            ...
            request.post("".concat(base_url, "/search_detail")).send((_request$post$send8 = {}, (0, _defineProperty2["default"])(_request$post$send8, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_request$post$send8, "page", 0), (0, _defineProperty2["default"])(_request$post$send8, "order", 'koujun'), _request$post$send8)).end(function (err, res) {
              response = res;
              done();
            });
          });
    ...
    describe('正常系', function () {
      ...
      before(function (done) {
        try {
          ...
          var sendQuery = (_sendQuery = {}, (0, _defineProperty2["default"])(_sendQuery, (0, _lodash.find)(meta_infos, {
            name: 'receive_company_name'
          })._id, "受信会社名"), (0, _defineProperty2["default"])(_sendQuery, "page", 0), (0, _defineProperty2["default"])(_sendQuery, "order", "asc"), _sendQuery);
          var newTag = {
            tag: {
              label: "新規タグ",
              color: "#FEDCBA"
          ...
          new Promise(function (resolve, reject) {
            ...
            return new Promise(function (resolve, reject) {
              meta_info_id = (0, _lodash.find)(meta_infos, {
                name: "receive_company_name"
              })._id;
              resolve(res);
            });
            ...
            return new Promise(function (resolve, reject) {
              request.get("".concat(base_url, "/search")).query({
                q: "メタ表示名"
            ...
            file_id = (0, _lodash.find)(res.body.body, {
              name: 'メタ表示名.txt'
            })._id;
          }).then(function (res) {
            return new Promise(function (resolve, reject) {
              request.get("/api/v1/users").end(function (err, res) {
                role_user = (0, _lodash.find)(res.body.body, {
                  name: "hanako"
                });
                resolve(res);
              });
            ...
            return new Promise(function (resolve, reject) {
              request.get("/api/v1/role_files").end(function (err, res) {
                role_file = (0, _lodash.find)(res.body.body, {
                  name: "フルコントロール"
                });
                resolve(res);
              });
            ...
            return new Promise(function (resolve, reject) {
              var url = "".concat(base_url, "/").concat(file_id, "/authorities");
            ...
            return new Promise(function (resolve, reject) {
              request.patch("".concat(base_url, "/").concat(file_id, "/toggle_star")).end(function (err, res) {
                resolve(res);
              });
            });
          }).then(function (res) {
      ...
      describe('検索', function () {
        describe('検索条件: text', function () {
          ...
          before(function (done) {
            try {
              ...
              var sendQuery = (_sendQuery2 = {}, (0, _defineProperty2["default"])(_sendQuery2, (0, _lodash.find)(search_items, {
                name: 'name'
              })._id, "text"), (0, _defineProperty2["default"])(_sendQuery2, "page", 0), (0, _defineProperty2["default"])(_sendQuery2, "order", "asc"), _sendQuery2);
              request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
                if (err) throw err;
                response = res;
                done();
              });
          ...
          it('_idはObjectIdである', function (done) {
            (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid((0, _lodash.first)(response.body.body)._id)).equal(true);
            done();
          });
          ...
          it('nameはstringである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).name)).equal('string');
            done();
          });
          ...
          it('mime_typeはstringである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).mime_type)).equal('string');
            done();
          });
          ...
          it('sizeはnumberである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).size)).equal('number');
            done();
          });
          ...
          it('is_dirはbooleanである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).is_dir)).equal('boolean');
            done();
          });
          ...
          it('dir_idはObjectIdである', function (done) {
            (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid((0, _lodash.first)(response.body.body).dir_id)).equal(true);
            done();
          });
          ...
          it('is_displayはbooleanである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).is_display)).equal('boolean');
            done();
          });
          ...
          it('is_starはbooleanである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).is_star)).equal('boolean');
            done();
          });
          ...
          it('is_cryptedはbooleanである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).is_crypted)).equal('boolean');
            done();
          });
          ...
          it('histories.actionはstringである', function (done) {
            var histories = (0, _lodash.first)(response.body.body).histories;
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(histories).action)).equal('string');
            done();
          });
          ...
          it('historiesのuserはobjectである', function (done) {
            var histories = (0, _lodash.first)(response.body.body).histories;
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(histories).user)).equal('object');
            done();
          });
          ...
          it('histories.modifiedはstringである', function (done) {
            var histories = (0, _lodash.first)(response.body.body).histories;
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(histories).modified)).equal('string');
            done();
          });
          ...
          it('is_deletedはbooleanである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).is_deleted)).equal('boolean');
            done();
          });
          ...
          it('modifiedはstringである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).modified)).equal('string');
            done();
          });
          ...
          it('preview_idはnullまたはObjectIdである', function (done) {
            if ((0, _lodash.first)(response.body.body).preview_id === null) {
              ...
              (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid((0, _lodash.first)(response.body.body).preview_id)).equal(true);
            }
          ...
          it('dir_routeはstringである', function (done) {
            (0, _chai.expect)((0, _typeof2["default"])((0, _lodash.first)(response.body.body).dir_route)).equal('string');
            done();
          });
        });
        describe.skip('検索条件 更新日時(より大きい): 前日', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery3 = {}, (0, _defineProperty2["default"])(_sendQuery3, (0, _lodash.find)(search_items, {
              name: 'modified_greater'
            })._id, (0, _moment["default"])().add('days', -1).format("YYYY-MM-DD HH:mm:ss")), (0, _defineProperty2["default"])(_sendQuery3, "page", 0), (0, _defineProperty2["default"])(_sendQuery3, "order", "asc"), _sendQuery3);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe.skip('検索条件 更新日時(より大きい): 今', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery4 = {}, (0, _defineProperty2["default"])(_sendQuery4, (0, _lodash.find)(search_items, {
              name: 'modified_greater'
            })._id, (0, _moment["default"])().format("YYYY-MM-DD HH:mm:ss")), (0, _defineProperty2["default"])(_sendQuery4, "page", 0), (0, _defineProperty2["default"])(_sendQuery4, "order", "asc"), _sendQuery4);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe.skip('検索条件 更新日時(より小さい): 前日', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery5 = {}, (0, _defineProperty2["default"])(_sendQuery5, (0, _lodash.find)(search_items, {
              name: 'modified_less'
            })._id, (0, _moment["default"])().add('days', -1).format("YYYY-MM-DD HH:mm:ss")), (0, _defineProperty2["default"])(_sendQuery5, "page", 0), (0, _defineProperty2["default"])(_sendQuery5, "order", "asc"), _sendQuery5);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe.skip('検索条件 更新日時(より小さい): 今', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery6 = {}, (0, _defineProperty2["default"])(_sendQuery6, (0, _lodash.find)(search_items, {
              name: 'modified_less'
            })._id, (0, _moment["default"])().format("YYYY-MM-DD HH:mm:ss")), (0, _defineProperty2["default"])(_sendQuery6, "page", 0), (0, _defineProperty2["default"])(_sendQuery6, "order", "asc"), _sendQuery6);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('検索条件 受信企業名（メタ情報）: 受信会社名', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery7 = {}, (0, _defineProperty2["default"])(_sendQuery7, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_sendQuery7, "page", 0), (0, _defineProperty2["default"])(_sendQuery7, "order", "asc"), _sendQuery7);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
          ...
          it('meta_infosに指定したメタ情報が含まれる', function (done) {
            (0, _chai.expect)((0, _lodash.findIndex)((0, _lodash.first)(response.body.body).meta_infos, {
              label: "受信企業名",
              value: "受信会社名"
            }) >= 0).equal(true);
            done();
        ...
        describe('検索条件 ファイル名:日本語', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery8 = {}, (0, _defineProperty2["default"])(_sendQuery8, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "日本語"), (0, _defineProperty2["default"])(_sendQuery8, "page", 0), (0, _defineProperty2["default"])(_sendQuery8, "order", "asc"), _sendQuery8);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('検索条件(複合) ファイル名:メタ表示名 ,受信企業名（メタ情報）: 受信会社名', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery9 = {}, (0, _defineProperty2["default"])(_sendQuery9, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_sendQuery9, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "メタ表示名"), (0, _defineProperty2["default"])(_sendQuery9, "page", 0), (0, _defineProperty2["default"])(_sendQuery9, "order", "asc"), _sendQuery9);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('検索条件が正規表現: text[1-3]', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery10 = {}, (0, _defineProperty2["default"])(_sendQuery10, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "text[1-3]"), (0, _defineProperty2["default"])(_sendQuery10, "page", 0), (0, _defineProperty2["default"])(_sendQuery10, "order", "asc"), _sendQuery10);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('タグで検索: 新規タグ', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery11 = {}, (0, _defineProperty2["default"])(_sendQuery11, (0, _lodash.find)(search_items, {
              name: 'tag'
            })._id, target_tag._id), (0, _defineProperty2["default"])(_sendQuery11, "page", 0), (0, _defineProperty2["default"])(_sendQuery11, "order", "asc"), _sendQuery11);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('メンバーで検索', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery12 = {}, (0, _defineProperty2["default"])(_sendQuery12, (0, _lodash.find)(search_items, {
              name: 'authorities'
            })._id, role_user._id.toString()), (0, _defineProperty2["default"])(_sendQuery12, "page", 0), (0, _defineProperty2["default"])(_sendQuery12, "order", "asc"), _sendQuery12);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('お気に入りで検索: true', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery13 = {}, (0, _defineProperty2["default"])(_sendQuery13, (0, _lodash.find)(search_items, {
              name: 'favorite'
            })._id, true), (0, _defineProperty2["default"])(_sendQuery13, "page", 0), (0, _defineProperty2["default"])(_sendQuery13, "order", "asc"), _sendQuery13);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('お気に入りで検索: false', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery14 = {}, (0, _defineProperty2["default"])(_sendQuery14, (0, _lodash.find)(search_items, {
              name: 'favorite'
            })._id, false), (0, _defineProperty2["default"])(_sendQuery14, "page", 0), (0, _defineProperty2["default"])(_sendQuery14, "order", "asc"), _sendQuery14);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('検索条件(複合) ファイル名:メタ表示名 ,受信企業名（メタ情報）: 受信会社名, メンバー:hanako', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery15 = {}, (0, _defineProperty2["default"])(_sendQuery15, (0, _lodash.find)(meta_infos, {
              name: 'receive_company_name'
            })._id, "受信会社名"), (0, _defineProperty2["default"])(_sendQuery15, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "メタ表示名"), (0, _defineProperty2["default"])(_sendQuery15, (0, _lodash.find)(search_items, {
              name: 'authorities'
            })._id, role_user._id.toString()), (0, _defineProperty2["default"])(_sendQuery15, "page", 0), (0, _defineProperty2["default"])(_sendQuery15, "order", "asc"), _sendQuery15);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
      ...
      describe('ページャー', function () {
        ...
        describe('検索条件: ファイル名:text, page:1 ,sort: name ,order: asc', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery16 = {}, (0, _defineProperty2["default"])(_sendQuery16, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "text"), (0, _defineProperty2["default"])(_sendQuery16, "page", 0), (0, _defineProperty2["default"])(_sendQuery16, "sort", (0, _lodash.find)(search_items, {
              name: 'name'
            })._id), (0, _defineProperty2["default"])(_sendQuery16, "order", "asc"), _sendQuery16);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('検索条件: ファイル名:text, page:1 ,sort: name ,order: desc', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery17 = {}, (0, _defineProperty2["default"])(_sendQuery17, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "text"), (0, _defineProperty2["default"])(_sendQuery17, "page", 0), (0, _defineProperty2["default"])(_sendQuery17, "sort", (0, _lodash.find)(search_items, {
              name: 'name'
            })._id), (0, _defineProperty2["default"])(_sendQuery17, "order", "desc"), _sendQuery17);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
        ...
        describe('検索条件: ファイル名:text, page:1 ,sort: display_file_name ,order: asc', function () {
          ...
          before(function (done) {
            ...
            var sendQuery = (_sendQuery18 = {}, (0, _defineProperty2["default"])(_sendQuery18, (0, _lodash.find)(search_items, {
              name: 'name'
            })._id, "txt"), (0, _defineProperty2["default"])(_sendQuery18, "page", 1), (0, _defineProperty2["default"])(_sendQuery18, "sort", (0, _lodash.find)(search_items, {
              name: 'display_file_name'
            })._id), (0, _defineProperty2["default"])(_sendQuery18, "order", "asc"), _sendQuery18);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
          ...
          it("メタ情報「表示ファイル名」の昇順である", function (done) {
            (0, _chai.expect)((0, _lodash.find)(response.body.body[0].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_value29");
            (0, _chai.expect)((0, _lodash.find)(response.body.body[1].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_value30");
            (0, _chai.expect)((0, _lodash.find)(response.body.body[2].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_value@###");
            (0, _chai.expect)((0, _lodash.find)(response.body.body[3].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_value[1]");
            (0, _chai.expect)((0, _lodash.find)(response.body.body[4].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_valuealpha");
            (0, _chai.expect)((0, _lodash.find)(response.body.body[5].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_valuealpha123");
            (0, _chai.expect)((0, _lodash.find)(response.body.body[6].meta_infos, {
              label: '表示ファイル名'
            }).value).equal("meta_value日本語");
            done();
          });
          it('返却値のlengthは30である', function (done) {
            var files = response.body.body.map(function (file) {
        ...
        describe("\u30E1\u30BF\u60C5\u5831\u300C\u53D7\u4FE1\u65E5\u6642\u300D\u691C\u7D22:".concat((0, _moment["default"])().add(1, "days").format("YYYY-MM-DD"), " ~ ").concat((0, _moment["default"])().add(3, "days").format("YYYY-MM-DD")), function () {
          var response;
          before(function (done) {
            var _sendQuery19;

            var sendQuery = (_sendQuery19 = {}, (0, _defineProperty2["default"])(_sendQuery19, (0, _lodash.find)(search_items, {
              name: 'receive_date_time'
            })._id, {
              "gt": (0, _moment["default"])().add(1, "days").format("YYYY-MM-DD"),
              "lt": (0, _moment["default"])().add(3, "days").format("YYYY-MM-DD")
            }), (0, _defineProperty2["default"])(_sendQuery19, "page", 0), (0, _defineProperty2["default"])(_sendQuery19, "sort", (0, _lodash.find)(search_items, {
              name: 'receive_date_time'
            })._id), (0, _defineProperty2["default"])(_sendQuery19, "order", "asc"), _sendQuery19);
            request.post("".concat(base_url, "/search_detail")).send(sendQuery).end(function (err, res) {
              response = res;
              done();
            });
          ...
          it('受信日時は明日から3日後までである', function (done) {
            (0, _chai.expect)((0, _moment["default"])((0, _lodash.find)(response.body.body[0].meta_infos, {
              label: '受信日時'
            }).value).format("YYYY-MM-DD")).equal((0, _moment["default"])().add(1, "days").format("YYYY-MM-DD"));
            (0, _chai.expect)((0, _moment["default"])((0, _lodash.find)(response.body.body[1].meta_infos, {
              label: '受信日時'
            }).value).format("YYYY-MM-DD")).equal((0, _moment["default"])().add(2, "days").format("YYYY-MM-DD"));
            (0, _chai.expect)((0, _moment["default"])((0, _lodash.find)(response.body.body[2].meta_infos, {
              label: '受信日時'
            }).value).format("YYYY-MM-DD")).equal((0, _moment["default"])().add(3, "days").format("YYYY-MM-DD"));
            done();
          });
        });
      });
