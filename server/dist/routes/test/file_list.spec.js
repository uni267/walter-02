...
var user;
var meta_infos; // テスト用のアップロードファイル(client側から送信しているPayload)
    ...
    before(function (done) {
      try {
        new Promise(function (resolve, reject) {
          ...
          return new Promise(function (resolve, reject) {
            // ファイルに先頭のタグ追加
            request.post("".concat(base_url, "/").concat(file_id, "/tags")).send(tags).end(function (err, res) {
              resolve(res);
            });
          });
        }).then(function (res) {
          ...
          // ファイルに先頭のメタ情報を追加
          meta_infos = (0, _lodash.find)(res.body.body, {
          ...
          return new Promise(function (resolve, reject) {
            request.post("".concat(base_url, "/").concat(file_id, "/meta")).send(meta).end(function (err, res) {
              resolve(res);
            });
          });
        }).then(function (res) {
    ...
    describe('異常系', function () {
      describe('dir_idが不正', function () {
        ...
        describe('dir_idが存在しないObjectId', function () {
          var response;
          before(function (done) {
            var id = new _mongoose["default"].Types.ObjectId().toString();
            ...
            if (res.body.body.length > 0) {
              return new Promise(function (resolve, reject) {
                res.body.body.map(function (file) {
                  return request["delete"]("".concat(base_url, "/").concat(file._id)).end(function (err, res) {
                    return res;
                  });
                });
                setTimeout(function () {
