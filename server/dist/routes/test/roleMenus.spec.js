...
describe(base_url, function () {
  ...
  describe('get /', function () {
    describe('正常系', function () {
      ...
      it('descriptionはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].description)).equal('string');
        done();
      });
      ...
      it('menusはobjectである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].menus)).equal('object');
        done();
      });
      ...
      it('menusの_idはObjectIdである', function (done) {
        (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body[0].menus[0]._id)).equal(true);
        done();
      });
      ...
      it('menusのnameはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].menus[0].name)).equal('string');
        done();
      });
      ...
      it('menusのlabelはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body[0].menus[0].label)).equal('string');
        done();
      });
      ...
      it('tenant_idはObjectIdである', function (done) {
        (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body[0].tenant_id)).equal(true);
        done();
      });
    });
  });
  ...
  describe('get /:role_id', function () {
    describe('異常系', function () {
      describe('存在しないrole_idを指定', function () {
        ...
        before(function (done) {
          ...
          request.get("".concat(base_url, "/").concat(id)).end(function (err, res) {
            response = res;
            done();
          });
        });
    ...
    describe('正常系', function () {
      ...
      it('_idはObjectIdである', function (done) {
        (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body._id)).equal(true);
        done();
      });
      it('nameが含まれる', function (done) {
      ...
      it('nameはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.name)).equal('string');
        done();
      });
      it('descriptionが含まれる', function (done) {
      ...
      it('descriptionはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.description)).equal('string');
        done();
      });
      it('tenant_idが含まれる', function (done) {
      ...
      it('tenant_idはObjectIdである', function (done) {
        (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body.tenant_id)).equal(true);
        done();
      });
      it('menusが含まれる', function (done) {
      ...
      it('menusはobjectである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.menus)).equal('object');
        done();
      });
      it('menusは_idが含まれる', function (done) {
      ...
      it('menusの_idはObjectIdである', function (done) {
        (0, _chai.expect)(_mongoose["default"].Types.ObjectId.isValid(response.body.body.menus[0]._id)).equal(true);
        done();
      });
      it('menusはnameが含まれる', function (done) {
      ...
      it('menusのnameはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.menus[0].name)).equal('string');
        done();
      });
      it('menusはlabelが含まれる', function (done) {
      ...
      it('menusのlabelはstringである', function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(response.body.body.menus[0].label)).equal('string');
        done();
      });
    });
  });
  describe('delete /:role_id', function () {
    ...
    describe('異常系', function () {
      describe('存在しないrole_id', function () {
        ...
        before(function (done) {
          var id = new _mongoose["default"].Types.ObjectId();
          request["delete"]("".concat(base_url, "/").concat(id)).end(function (err, res) {
            response = res;
            done();
          });
        });
    ...
    describe('正常系', function () {
      var response;
      before(function (done) {
        request["delete"]("".concat(base_url, "/").concat(targetData._id)).end(function (err, res) {
          response = res;
          done();
        });
      });
  ...
  describe('patch /:role_id/name', function () {
    ...
    describe('異常系', function () {
      describe('存在しないrole_idを更新する', function () {
        ...
        before(function (done) {
          var id = new _mongoose["default"].Types.ObjectId();
          request.patch("".concat(base_url, "/").concat(id, "/name")).send(sendData).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('nameが未定義', function () {
        ...
        describe('nameがundefined', function () {
          ...
          var response;
          before(function (done) {
            request.patch("".concat(base_url, "/").concat(targetData._id, "/name")).send(sendData).end(function (err, res) {
              response = res;
              done();
            });
          });
    ...
    describe('正常系', function () {
      ...
      it('nameが送信した値に更新されていること', function (done) {
        request.get("".concat(base_url, "/").concat(targetData._id)).end(function (err, res) {
  ...
  describe('patch /:role_id/description', function () {
    ...
    describe('異常系', function () {
      describe('存在しないrole_idを更新する', function () {
        ...
        before(function (done) {
          var id = new _mongoose["default"].Types.ObjectId();
          request.patch("".concat(base_url, "/").concat(id, "/description")).send(sendData).end(function (err, res) {
            response = res;
            done();
          });
        });
    ...
    describe('正常系', function () {
      describe('descriptionのみ送信', function () {
        ...
        var response;
        before(function (done) {
          request.patch("".concat(base_url, "/").concat(targetData._id, "/description")).send(sendData).end(function (err, res) {
            response = res;
            done();
          });
        });
  ...
  describe('patch /:role_id/menus/:menu_id', function () {
    ...
    describe('異常系', function () {
      describe('存在しないrole_idを更新する', function () {
        ...
        before(function (done) {
          ...
          var id = new _mongoose["default"].Types.ObjectId();
          request.patch("".concat(base_url, "/").concat(id, "/menus/").concat(menu._id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('存在しないmenuを登録する', function () {
        ...
        before(function (done) {
          var menu = (0, _lodash.first)(menus);
          var id = new _mongoose["default"].Types.ObjectId();
          request.patch("".concat(base_url, "/").concat(targetData._id, "/menus/").concat(id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('既に登録されているmenuを登録する', function () {
        ...
        before(function (done) {
          var menu = (0, _lodash.first)(menus);
          var url = "".concat(base_url, "/").concat(targetData._id, "/menus/").concat(menu._id);
    ...
    describe('正常系', function () {
      ...
      before(function (done) {
        ...
        request.patch("".concat(base_url, "/").concat(targetData._id, "/menus/").concat(targetMenu._id)).end(function (err, res) {
          response = res;
          done();
        });
      });
  ...
  describe('delete /:role_id/menus/:menu_id', function () {
    ...
    describe('異常系', function () {
      describe('存在しないrole_idを更新する', function () {
        ...
        before(function (done) {
          var id = new _mongoose["default"].Types.ObjectId();
          request["delete"]("".concat(base_url, "/").concat(id, "/menus/").concat(targetMenu._id)).end(function (err, res) {
            response = res;
            done();
          });
        });
      ...
      describe('存在しないmenuを削除する', function () {
        ...
        before(function (done) {
          var id = new _mongoose["default"].Types.ObjectId();
          request["delete"]("".concat(base_url, "/").concat(targetData._id, "/menus/").concat(id)).end(function (err, res) {
            response = res;
            done();
          });
        });
    ...
    describe('正常系', function () {
      ...
      before(function (done) {
        ...
        request["delete"]("".concat(base_url, "/").concat(targetData._id, "/menus/").concat(targetMenu._id)).end(function (err, res) {
          response = res;
          done();
        });
      });
