...
describe(user_url + "/:user_id", function () {
  ...
  describe("get /", function () {
    describe("ログインユーザのuser_idを指定した場合", function () {
      ...
      it("1個のオブジェクトが返却される", function (done) {
        (0, _chai.expect)((0, _typeof2["default"])(payload.body.body) === "object").equal(true);
        done();
      });
  ...
  describe("post /:user_id/groups", function () {
      ...
      before(function (done) {
        new Promise(function (resolve, reject) {
          ...
          return new Promise(function (resolve, reject) {
            request.post(user_url + "/".concat(user._id, "/groups")).send({
              group_id: group_id
      ...
      describe("存在しないoidの場合", function () {
        ...
        before(function (done) {
          new Promise(function (resolve, reject) {
            ...
            return new Promise(function (resolve, reject) {
              request.post(user_url + "/invalid_oid/groups").send({
                group_id: group_id
              }).end(function (err, res) {
                resolve(res);
              });
    ...
    describe("指定されたgroup_idが", function () {
      describe("undefinedの場合", function () {
        ...
        before(function (done) {
          new Promise(function (resolve, reject) {
            request.post(user_url + "/".concat(user._id, "/groups")).end(function (err, res) {
              return resolve(res);
            });
          }).then(function (res) {
            payload = res;
      ...
      describe("重複している場合", function () {
        ...
        before(function (done) {
          new Promise(function (resolve, reject) {
            request.post(user_url + "/".concat(user._id, "/groups")).send({
              group_id: (0, _lodash.head)(user.groups)
            }).end(function (err, res) {
              return resolve(res);
            });
          }).then(function (res) {
  ...
  describe("patch /:user_id/password", function () {
    ...
    afterEach(function (done) {
      new Promise(function (resolve, reject) {
        request.patch(user_url + "/".concat(user._id, "/password_force")).send({
    ...
    describe("ログインユーザのuser_id、正しいパスワードを指定した場合", function () {
      ...
      before(function (done) {
        new Promise(function (resolve, reject) {
          request.patch(user_url + "/".concat(user._id, "/password")).send(body).end(function (err, res) {
            return resolve(res);
          });
        }).then(function (res) {
          payload = res;
  ...
  describe("patch /:user_id/password_force", function () {
    ...
    describe("ログインユーザのuser_id、正しいパスワードを指定した場合", function () {
      ...
      before(function (done) {
        new Promise(function (resolve, reject) {
          request.patch(user_url + "/".concat(user._id, "/password_force")).send(body).end(function (err, res) {
            return resolve(res);
          });
        }).then(function (res) {
          payload = res;
