...
exports.addActionToRoleFile = exports.removeActionOfRoleFile = exports.remove = exports.updateDescription = exports.updateName = exports.view = exports.create = exports.index = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _RoleFile["default"].aggregate([{
              $match: {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 15:
            newRoleFile = new _RoleFile["default"]();
...
var removeActionOfRoleFile = function removeActionOfRoleFile(req, res, next) {
  (0, _co["default"])(
  /*#__PURE__*/
    ...
    return _regenerator["default"].wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 6:
            _context7.next = 8;
            return [_RoleFile["default"].findById(role_id), _Action["default"].findById(action_id)];
...
exports.removeActionOfRoleFile = removeActionOfRoleFile;

var addActionToRoleFile = function addActionToRoleFile(req, res, next) {
  (0, _co["default"])(
  /*#__PURE__*/
    ...
    return _regenerator["default"].wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 18:
            role.actions = [].concat((0, _toConsumableArray2["default"])(role.actions), [action._id]);
            _context8.next = 21;
            return role.save();
...
exports.addActionToRoleFile = addActionToRoleFile;