  ...
  co(function* () {
    try {
      ...
      const file_prperties={
        ...
        is_dir: { type:"text", index: false },
        dir_id: { type:"text", index: false },
        is_display: { type:"boolean", index: false },
        is_star: { type:"boolean", index: false },
        is_crypted: { type:"boolean", index: false },
        is_deleted: { type:"boolean", index: false },
