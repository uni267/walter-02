...
// フォルダ詳細
export const REQUEST_FETCH_DIR = "REQUEST_FETCH_DIR";
export const SET_DIR_ACTION = "SET_DIR_ACTION";
...
// ファイルのタイムスタンプ
export const TOGGLE_TIMESTAMP_DIALOG = "TOGGLE_TIMESTAMP_DIALOG";
export const TOGGLE_TIMESTAMP_CONFIRM_DIALOG = "TOGGLE_TIMESTAMP_CONFIRM_DIALOG";
export const UPDATE_TIMESTAMP_TARGET_FILE = "UPDATE_TIMESTAMP_TARGET_FILE";
...
// 自動タイムスタンプ
export const TOGGLE_AUTO_TIMESTAMP_DIALOG = "TOGGLE_AUTO_TIMESTAMP_DIALOG";
export const TOGGLE_AUTO_TIMESTAMP = "TOGGLE_AUTO_TIMESTAMP";
...
export const SET_TAGS_ORDER_NUMBER = "SET_TAGS_ORDER_NUMBER";
export const SAVE_TAGS_ORDER_NUMBER = "SAVE_TAGS_ORDER_NUMBER";
...
// テナントの設定
export const REQUEST_FETCH_APP_SETTINGS = "REQUEST_FETCH_APP_SETTINGS";
export const INIT_APP_SETTINGS = "INIT_APP_SETTINGS";
export const TOGGLE_DISPLAY_UNVISIBLE_FILES = "TOGGLE_DISPLAY_UNVISIBLE_FILES";

// タイムスタンプ発行
export const ISSUE_TIMESTAMP = "ISSUE_TIMESTAMP";
// タイムスタンプ検証
export const VERIFY_TIMESTAMP = "VERIFY_TIMESTAMP";
// タイムスタンプトークンダウンロード
export const DOWNLOAD_TIMESTAMP_TOKEN = "DOWNLOAD_TIMESTAMP_TOKEN";
